...
import System.Posix.Resource (Resource(..), ResourceLimits(..), ResourceLimit(..), setResourceLimit)

-- | Pull together several methods of reducing priority and
-- easy access to resources: 'nice', and the rlimit bindings.
...
stackSizeLimitSoft, stackSizeLimitHard, totalMemoryLimitSoft, totalMemoryLimitHard :: ResourceLimit
dataSizeLimitSoft, openFilesLimitSoft, openFilesLimitHard, fileSizeLimitSoft, fileSizeLimitHard :: ResourceLimit
...
openFilesLimitHard = ResourceLimit 20
...
dataSizeLimitHard = ResourceLimit $ 60 ^ (12 :: Int)
